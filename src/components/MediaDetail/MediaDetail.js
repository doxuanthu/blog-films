...
function MediaDetail() {
  ...
  useEffect(() => {
    ...
    fac
      .getColorAsync(corsImageModified, {
        algorithms: "dominant",
      })
      .then((color) => {
        console.log(color);
  ...
  useEffect(() => {
    ...
    if (type === "movie") {
      const fetchMovieDetail = async () => {
        const response = await movieApi.getMovieDetails(
  ...
  useEffect(() => {
    ...
    if (type === "movie") {
      const fetchMovieTrailers = async () => {
        const response = await movieApi.getTrailersMovieById(
          Number.parseFloat(id),
          params
        );
              ...
              <div className={cx("poster-wrapper")}>
                <div
                  ...
                  onClick={() =>
                    handleOpenModal(
                      controlPosterModal,
                      "MediaDetail_modal-wrapper__MxJef"
                    )
                  }
                >
                ...
                <ul className={cx("auto-actions", "d-flex")}>
                  <li className={cx("chart", "d-flex")}>
                    <Progress
                      ...
                      trailColor="#204529"
                      strokeColor={
                        mediaCurrent?.vote_average >= 7 ? "#21d07a" : "#d2d531"
                      }
                    />
                  ...
                  <li className={cx("video")}>
                    <div
                      onClick={() =>
                        handleOpenModal(
                          controlTrailerModal,
                          "MediaDetail_modal-trailer__6vO8V"
                        )
                      }
