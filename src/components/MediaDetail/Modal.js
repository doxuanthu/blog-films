...
function Modal({ colection }) {
  ...
  const handleCloseImageModal = () => {
    document
      .querySelector(".MediaDetail_modal-wrapper__MxJef")
      .classList.remove("full-gray");
    ...
    <>
      ...
      <div className={cx("inner-modal", "image-modal")}>
        <div
          ...
          className={cx("image-poster", "d-flex")}
        >
          {isLoading ? (
            <img
        ...
        <div className={cx("info-poster", "d-flex")}>
          ...
          <div className={cx("meta")}>
            ...
            <form>
              <label>Size</label>
              <p>
                {colection?.[currPoster]?.width}x
                {colection?.[currPoster]?.height}
              </p>
            </form>
          </div>
          {currPoster && (
